...
export default /* abstract */ class EpisodeList extends React.Component<EpisodeListProps, EpisodeListState> {
    ...
    constructor(props: EpisodeListProps) {                  // Le pasamos las propiedades del componente
        ...
        this.state = { episodes: [], loading: true };       // Inicializamos el estado del componente
    ...
    // protected abstract loadPage(page: number): Promise<ResultMovieList>; // Método abstracto que debe ser implementado por las subclases para cargar las películas de una página específica
